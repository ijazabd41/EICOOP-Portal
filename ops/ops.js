...
function renderHome(){
  ...
  let notifs = '';
  if(o.transfers_waiting_operations>0) notifs += `<div class="notice-banner alert-ops"><strong>Attention:</strong> ${fmt(o.transfers_waiting_operations)} transfer(s) waiting for Operations approval.</div>`;
  if(o.transfers_waiting_chairman>0) notifs += `<div class="notice-banner alert-chair"><strong>Attention:</strong> ${fmt(o.transfers_waiting_chairman)} transfer(s) waiting for Chairman approval.</div>`;
